# FedexDomainExpert — Codex Session Context
...
### Actions Available to Codex (agentic loop)
...
- `qa_needed` — Codex is stuck, asks QA a specific question
...
|---|---|---|
| AI QA Agent, domain expert chat | `Codex-sonnet-4-6` | `CLAUDE_SONNET_MODEL` |
| Card processing, feature detection | `Codex-haiku-4-5-20251001` | `CLAUDE_HAIKU_MODEL` |
...
4. **Codex flying blind** → no screenshot → fixed: base64 PNG passed as Anthropic image block in `_decide_next()`
